...
if __name__ == "__main__":
    ...
    expe_path = "2020/11/12_13_finetune_sparse_facto_palm_act"

    lst_path_finetune = [
        "2020/07/11_12_finetune_sparse_facto_fix_replicates",
        "2020/07/11_12_finetune_sparse_factro_fix_only_mask",
        "2020/11/12_13_finetune_sparse_facto_palm_act_light",
        "2020/11/12_13_finetune_sparse_facto_palm_act_no1b_light"
    ]
    ...
    for idx, (_, row) in enumerate(df_finetune.iterrows()):
        ...
        dct_attributes["full-net-approx"].append(bool(row["--full-model-approx"]) if not np.isnan(row["--full-model-approx"]) else False)
