...
if __name__ == "__main__":
    ...
    expe_path = "2020/04/1_2_finetune_faust_no_hierarchical"

    lst_path_finetune = [
        "2020/04/0_0_finetune_faust_sp_6_8_fac_2",
        "2020/04/1_2_finetune_faust_no_hierarchical"
    ]

    lst_path_compression = [
        "2020/04/0_1_compression_faust_sp_6_8_fac_2",
        "2020/04/0_0_compression_faust"
    ]
