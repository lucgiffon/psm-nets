...
if __name__ == "__main__":
    ...
    expe_path = "2020/05/3_4_finetune_faust_no_hierarchical_only_cifar_mnist"

    lst_path_finetune = [
        "2020/05/3_4_finetune_faust_no_hierarchical_only_cifar_mnist"
    ]

    lst_path_compression = [
        "2020/05/2_3_compression_faust_not_hier"
    ]
