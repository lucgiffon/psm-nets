...
if __name__ == "__main__":
    ...
    experiment_name = "2020/05/2_3_compression_tensortrain"

    lst_paths_finetune = [
        "2020/05/2_3_compression_tensortrain",
        "2020/05/3_4_compression_tensortrain_use_pretrained_only_mnist",
        "2020/05/3_4_compression_tensortrain_use_pretrained_not_mnist",
    ]
