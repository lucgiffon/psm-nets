...
if __name__ == "__main__":
    ...
    expe_path_explore_params ="2020/04/11_12_finetune_palminized_explore_param"
    expe_path_explore_params_errors ="2020/04/11_12_finetune_palminized_explore_param_errors"
    ...
    columns_not_to_num = ['hash', 'output_file_csvcbprinter', 'results_dir', 'output_file_modelprinter', "--use-clr"]
