...
if __name__ == "__main__":
    ...
    expe_path_no_useless = "2020/03/9_10_finetune_palminized_no_useless"
    expe_path_palminize_from_scratch = "2020/03/2_3_palminize_from_scratch"

    src_results_dir_no_useless = root_source_dir / expe_path_no_useless
    src_results_dir_palminize_from_scratch = root_source_dir / expe_path_palminize_from_scratch
    ...
    df_palminized_no_useless = df_palminized_no_useless[df_palminized_no_useless["finetuned_score"] != "None"]
    df_palminized_no_useless = df_palminized_no_useless.drop(columns="oar_id").drop_duplicates()

    df_palminize_from_scratch = get_df(src_results_dir_palminize_from_scratch)
    df_palminize_from_scratch = df_palminize_from_scratch.assign(results_dir=[str(src_results_dir_palminize_from_scratch.absolute())] * len(df_palminize_from_scratch))
    ...
    df_palminize_from_scratch.loc[:, df_palminize_from_scratch.columns.difference(columns_not_to_num)] = df_palminize_from_scratch.loc[:, df_palminize_from_scratch.columns.difference(columns_not_to_num)].apply(pd.to_numeric, errors='coerce')
