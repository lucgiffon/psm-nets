...
if __name__ == "__main__":
    ...
    expe_path = "2020/05/9_10_finetune_sparse_facto_not_log_all_seeds"

    lst_path_finetune = [
        "2020/05/9_10_finetune_sparse_facto_not_log_all_seeds",
        "2020/05/10_11_finetune_sparse_facto_not_log_all_seeds_only_mask",
        "2020/05/11_12_finetune_sparse_facto_not_log_resnet"
    ]
    ...
    for idx, (_, row) in enumerate(df_finetune.iterrows()):
        ...
        if bool_resnet_new and np.isnan(row["test_loss_finetuned_model"]) :
            continue
            pass
