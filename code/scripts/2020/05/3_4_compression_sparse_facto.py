...
Usage:
    script.py [-h] [-v|-vv] (faust|palm) [--nb-factor=int] --sparsity-factor=int [--nb-iteration-palm=int] [--tol=float] [--hierarchical] (--mnist|--svhn|--cifar10|--cifar100|--test-data) [--cifar100-resnet50|--cifar100-resnet50-new|--cifar100-resnet20-new|--cifar100-resnet20|--mnist-500|--mnist-lenet|--test-model|--cifar10-vgg19|--cifar100-vgg19|--svhn-vgg19]
...
def compress_model(base_model):
    ...
    if paraman["faust"]:
        ...
        layer_replacer = LayerReplacerPalm(only_mask=False, sparse_factorizer=palminizer, path_checkpoint_file=paraman["output_file_modelprinter"])
    else:
