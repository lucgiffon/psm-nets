...
Usage:
    script.py [-h] [-v|-vv] (--mnist|--svhn|--cifar10|--cifar100|--test-data) [--nb-factor=int] [--cifar100-resnet50|--cifar100-resnet20|--mnist-500|--mnist-lenet|--test-model|--cifar10-vgg19|--cifar100-vgg19|--svhn-vgg19] --sparsity-factor=int [--nb-iteration-palm=int] [--delta-threshold=float] [--hierarchical]
