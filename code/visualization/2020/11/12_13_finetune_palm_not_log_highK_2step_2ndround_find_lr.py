...
if __name__ == "__main__":
    ...
    results_path = "2020/11/12_13_finetune_palm_not_log_highK_2step_2ndround_find_lr"
    ...
    with open(output_dir / "finetune_palm_not_log_highK_2step_2ndround_find_lr.yml", 'w') as outfile:
        yaml.dump(dct_results, outfile, default_flow_style=False)

    with open(output_dir / "finetune_palm_not_log_highK_2step_2ndround_find_lr.yml", 'r') as outfile:
