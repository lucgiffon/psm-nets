...
tasks = {
    ...
    ("diff-only-layer-processing-val", "diff-only-layer-processing-val"),
    ("diff-only-layer-processing-train", "diff-only-layer-processing-train"),
    ("diff-total-processing-val", "diff-total-processing-val"),
    ("diff-total-processing-train", "diff-total-processing-train"),
...
if __name__ == "__main__":
    ...
    results_path = "2020/11/11_12_compression_palm_act"
    ...
    df = df[(df["nb-iteration-palm"] == 300) & (df["model"] == "resnet20") & ((df["only-one-batch"] == True) | (df["activations"] == False))]
        ...
        for dataname in datasets:
            ...
            for modelname in df_model_values:
                ...
                for idx_row, (_, row) in enumerate(df_model.iterrows()):
                    ...
                    only_one_batch_str = "B " if bool(row["only-one-batch"]) else ""
                    if bool(row["only-one-batch"]) and bool(row["activations"]) and row['nb-epochs'] != 1:
                        continue

                    # if row["batch-size"] == 128:
                    #     continue

                    nb_epochs = f"Epochs: {row['nb-epochs']}"
                    epsilon = f"eps: {row['epsilon-lr']}"
                    batch_size = f"Bsize: {row['batch-size']}"


                    # config string
                    str_config_legend = f"{only_one_batch_str}{full_net_str}{activations_str}K={sp_fac_palm} Q={nb_fac_param} iter={nb_iter_pal} {train_percentage}% {nb_epochs} {epsilon} {batch_size}"
                ...
                dct_name_trace = {
                    ...
                    "B FULL ACT K=3 Q=3 iter=10 1.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=10 1.00%",
                    "B FULL ACT K=3 Q=3 iter=300 1.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=300 1.00%",
                    "B FULL ACT K=3 Q=3 iter=10 5.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=10 5.00%",
                    "B FULL ACT K=3 Q=3 iter=10 10.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=10 10.00%",
                    "B FULL ACT K=3 Q=3 iter=5 1.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=5 1.00%",
                    "B FULL ACT K=3 Q=3 iter=5 5.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=5 5.00%",
                    "B FULL ACT K=3 Q=3 iter=5 10.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=5 10.00%",
                    "B FULL ACT K=3 Q=3 iter=50 1.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=50 1.00%",
                    "B FULL ACT K=3 Q=3 iter=50 5.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=50 5.00%",
                    "B FULL ACT K=3 Q=3 iter=50 10.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=50 10.00%",
                    "B FULL ACT K=3 Q=3 iter=100 1.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=100 1.00%",
                    "B FULL ACT K=3 Q=3 iter=100 5.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=100 5.00%",
                    "B FULL ACT K=3 Q=3 iter=100 10.00%": "B FULL ACT Sparse Facto. K=3 Q=3 iter=100 10.00%",
                }
