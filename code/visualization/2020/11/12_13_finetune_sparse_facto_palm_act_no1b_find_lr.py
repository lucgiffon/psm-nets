...
if __name__ == "__main__":
    ...
    results_path = "2020/11/12_13_finetune_sparse_facto_palm_act_no1b_find_lr"
    ...
    with open(output_dir / "finetune_sparse_facto_act_no1b.yml", 'w') as outfile:
        yaml.dump(dct_results, outfile, default_flow_style=False)

    with open(output_dir / "finetune_sparse_facto_act_no1b.yml", 'r') as outfile:
