...
if __name__ == "__main__":
    ...
    results_path = "2020/09/9_10_compression_palm_act"
        ...
        for dataname in datasets:
            ...
            for modelname in df_model_values:
                ...
                for idx_row, (_, row) in enumerate(df_model.iterrows()):
                    ...
                    # config string
                    str_config_legend = f"{only_one_batch_str}{full_net_str}{activations_str}K={sp_fac_palm} Q={nb_fac_param} iter={nb_iter_pal} {train_percentage}% {nb_epochs}"
