...
class TestTTLayers(unittest.TestCase):
    ...
    def build_model(tt_ranks_conv = (2, 2, 2, 2, 1), tt_ranks_dense = (1, 2, 2, 2, 1)):
        ...
        model.add(TTLayerConv(window=[3, 3], nb_filters=512, inp_modes=[4, 4, 4, 8], out_modes=[4, 4, 4, 8], mat_ranks=tt_ranks_conv, mode="manual", name="ttlayerconv_1"))
        model.add(TTLayerConv(window=[3, 3], nb_filters=512, inp_modes=[4, 4, 4, 8], out_modes=[4, 4, 4, 8], mat_ranks=tt_ranks_conv, mode="auto", name="ttlayerconv_2"))
        model.add(TTLayerConv(window=[3, 3], nb_filters=512, out_modes=[4, 4, 4, 8], mat_ranks=tt_ranks_conv, mode="auto", name="ttlayerconv_3"))
        model.add(TTLayerConv(window=[3, 3], nb_filters=512, inp_modes=[4, 4, 4, 8], mat_ranks=tt_ranks_conv, mode="auto", name="ttlayerconv_4"))
        model.add(TTLayerConv(window=[3, 3], nb_filters=512, mat_ranks=tt_ranks_conv, mode="auto", name="ttlayerconv_5"))
        model.add(Conv2D(512, (3, 3), padding='same', input_shape=input_shape))
    ...
    def build_model_full_auto(nb_dim, tt_ranks_conv = (2, 2, 2, 2, 1), tt_ranks_dense = (1, 2, 2, 2, 1)):
        ...
        model.add(TTLayerConv(window=[3, 3], nb_filters=nb_dim, mat_ranks=tt_ranks_conv, mode="auto", name="ttlayerconv"))
